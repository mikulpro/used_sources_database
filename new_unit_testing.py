...
class BookApiTest(unittest.TestCase):
    ...
    def test_get_book_by_author(self):
        ...
        response = self.app.get("/books?author=Mock Author")
    ...
    def test_get_book_invalid_year(self):
        response = self.app.get("/books?year=abcd")
    ...
    def test_update_book(self):
        ...
        response = self.app.put("/books/2", json=update_data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_book(self):
        ...
        post_response = self.app.post("/books", json=book_data)

        with open("new_unit_testing_log.txt", "w") as f:
            f.write(f"post_response: {post_response}")
